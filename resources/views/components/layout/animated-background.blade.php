...
<div class="fixed inset-0 overflow-hidden pointer-events-none z-0">
    ...
    <div class="absolute top-32 left-1/4 text-amber-600/35 dark:text-amber-500/15 animate-bounce"
        style="animation-duration: 4s;">
        <svg class="w-10 h-10" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z" />
        </svg>
    </div>
    <div class="absolute top-1/3 right-1/4 text-orange-600/32 dark:text-orange-500/12 animate-bounce"
        style="animation-duration: 5s; animation-delay: 1s;">
        <svg class="w-14 h-14" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z" />
        </svg>
    </div>
    <div class="absolute bottom-1/3 left-1/3 text-amber-600/33 dark:text-amber-400/13 animate-bounce"
